...
const Layout = ({ children }) => {
  return (
    <div className="w-full min-h-screen bg-gray-50 flex flex-col items-center justify-start relative">
      ...
      <div className="w-full flex items-start justify-center z-10 py-6">
        <div className="w-[100%] flex flex-col">
          {children}
        </div>
      </div>
        <footer className="w-full bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-8 mt-auto">
        <div className="container mx-auto text-center relative z-10">
          ...
          <p className="font-medium">© {new Date().getFullYear()} HERE Mexico Hackathon. All rights reserved.</p>
          <p className="text-sm mt-3 text-blue-300">Built with ❤️ for the HERE Mexico Hackathon 2025</p>
          <div className="mt-4 pt-4 border-t border-gray-700 flex justify-center space-x-6">
            ...
            <a href="https://developer.here.com" className="text-gray-400 hover:text-white transition-colors duration-300">
              <span className="sr-only">HERE Developer</span>
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
